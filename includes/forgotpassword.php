...
$chngpwd1->execute();
echo "<script>alert('Changed Password succesfully');</script>";
}
else {
echo "<script>alert('Email/Mobile not valid');</script>"; 
}
}
...
<div class="modal fade" id="forgotpassword">
  ...
  <div class="form-group">
              ...
              <div class="text-center">
                <p class="gray_text">For security reasons we don't store your password. Your password will be reset.</p>
